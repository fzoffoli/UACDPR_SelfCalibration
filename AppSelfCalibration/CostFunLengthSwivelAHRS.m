function [fun,grad,J] = CostFunLengthSwivelAHRS(MyUACDPR,X,k,delta_length,delta_swivel,roll,pitch,delta_yaw,sensor_disturb)
...
if nargout>1
    ...
    for i = 1:k
        ...
        J_zeta(k*n+i*n-(n-1):k*n+i*n,i*6-5:i*6) = J_swivel(:,:,i);
