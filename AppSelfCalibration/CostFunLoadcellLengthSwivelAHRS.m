function [fun,grad,J] = CostFunLoadcellLengthSwivelAHRS(MyUACDPR,X,k,tau,delta_length,delta_swivel,roll,pitch,delta_yaw,sensor_disturb)
...
for i=1:k
    ...
    [tau_model, J_tau_model] = CalcInverseStaticsAndGradient(MyUACDPR,zeta_k);
...
if nargout>1
    ...
    J_zeta_0 = [zeros(k*n,n_d);J_length_0;J_swivel_0;J_psi_0];
