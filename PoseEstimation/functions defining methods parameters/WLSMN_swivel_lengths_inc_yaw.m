function [S,j] = WLSMN_swivel_lengths_inc_yaw(S,j,MyUACDPR,amperr_l,amperr_sigma,amperr_rollpitch,amperr_yaw,eps)
    ...
    % Algorithm options
    S(j).Optimization.Options.Single_Equation_Tolerance =  [(1+eps)*amperr_l;
                                                            (1+eps)*amperr_sigma;
                                                            (1+eps)*amperr_rollpitch;
                                                            (1+eps)*amperr_yaw]; 
