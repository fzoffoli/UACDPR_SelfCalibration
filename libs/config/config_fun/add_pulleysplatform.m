function add_pulleysplatform(btn,tg,PointTab,PulleyTab,s)
s.a=1
if length(PulleyTab.Children)+1>9
        msgbox('cannot exceed maximum number of pulleys (9)')
else
for i=length(PulleyTab.Children)+1
