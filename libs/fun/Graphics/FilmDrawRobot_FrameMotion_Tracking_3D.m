function [FF] = FilmDrawRobot_FrameMotion_Tracking_3D(PoseList,PoseFrameList,PoseObjList,Pos_robot,obj,orient)
 fig=figure
 hold on
 axis('equal')
...
%         WidthPoint{i}=obj.EndEffector.GlobalAttachPoints{i}-obj.EndEffector.RotMatrix*[0;0;.3];
        WidthPoint{i}=obj.EndEffector.GlobalAttachPoints{i}-obj.EndEffector.RotMatrix*[0;0;.5];
    end
